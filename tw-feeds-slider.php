<?php
/*
Plugin Name: TW Feeds Slider
Plugin URI: https://wordpress.org/plugins/tw-feeds-slider/
Description: TW Feeds Slider - Display your twitter feeds on your website. Powered by TwitterWidget.COM
Version: 1.1
Author: twidgets
...
class RealTwitterSlider{
    ...
    public  function add_twitter_tools_options_page(){
        ...
        add_options_page('TW Feeds Slider', 'TW Feeds Slider ', 'administrator', __FILE__, array('RealTwitterSlider','real_twitter_tools_options'));
...
<?php
    ...
    public function real_twitter_register_settings_and_fields(){
        ...
        add_settings_field('pageid', 'Twitter Widgets ID', array($this,'pageid_settings'), __FILE__,'real_twitter_main_section');
...
$print_twitter = '';
if($pageURL == ''){
$print_twitter.='<div class="error_kudos">Please Fill Out The TW Feeds Slider Configuration First</div>';	
} else {
